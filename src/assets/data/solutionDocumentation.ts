    ...
    lists: [
      {
        ...
        description: 'solutions.items.documentation.features.2.lists.1.description',
      },
      {
        title: 'solutions.items.documentation.features.4.lists.2.title',
        description: 'solutions.items.documentation.features.2.lists.2.description',
      },
      {
        title: 'solutions.items.documentation.features.4.lists.3.title',
        description: 'solutions.items.documentation.features.2.lists.3.description',
      },
    ],
    placement: 'right',
