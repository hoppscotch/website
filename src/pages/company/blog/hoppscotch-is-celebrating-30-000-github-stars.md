...
- App: [hoppscotch.io](http://hoppscotch.io/)
...
Look around - think about the tools and products you use every day and the underlying problems they solve.

Instead of identifying a solution first, the initial step is to identify the problem.

**The key here is to be very specific about the problem you are identifying.**
...
Read more in my article: [Solve your own problem, everything else will follow](https://dev.to/liyasthomas/solve-your-own-problem-everything-else-will-follow-12bc).

**2. Build in public**

Document your journey of building the project. Engage with your users in public forums like [dev.to](https://dev.to/). Write blogs and articles, talk to your audience, share your milestones, ask for help, get feedback and iterate over the product.

**3. Build for public**

Ship early, ship often. Release the first version as soon as it’s useful. Don’t wait for it to be perfect. For inspiration, [here's the initial public MVP release of Hoppscotch](https://codepen.io/liyasthomas/full/XWNGRoo). You don’t have to be satisfied with it. You’ll never be. But you should be eager for some feedback.
...
Me and [Andrew Bastin](https://dev.to/andrewtheant) have been building Hoppscotch in public for the past ~2 years. Today is the starting point of many exciting moves and features that will come to Hoppscotch from the very beginning of next month.
