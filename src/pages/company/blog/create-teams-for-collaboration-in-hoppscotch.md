...
Today we're launching Teams Collaboration support in Hoppscotch.
...
- Visit **[Profile page](https://hoppscotch.io/profile)** → Teams tab
- Click "**Create new team**"
- Give the team a name → "**Save**"

### Invite team members

- Click "**[Invite](https://hoppscotch.io/)**" on the top-right corner → Select a team
- Add team members emails and set permissions → Click "**Invite**"
...
[Roles](Create%20Tea%2010726/Roles%20043a8.csv)
...
Join our **[Discord server](https://hoppscotch.io/discord)** or **[Subscribe to our Newsletter](https://hoppscotch.io/newsletter)** to stay up to date with the latest happenings in the product.
