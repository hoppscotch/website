<script setup lang="ts">
  useHead({
    title: "v2023.4.1 • Changelog • Hoppscotch",
    meta: [
      {
        property: "og:title",
        content: "v2023.4.1 • Changelog • Hoppscotch",
      },
      {
        name: "twitter:title",
        content: "v2023.4.1 • Changelog • Hoppscotch",
      ...
      },
      {
        property: "og:image",
        content:
          "https://hoppscotch.com/.netlify/functions/og-image?type=changelog&slug=23-04-2023",
      },
      {
        name: "twitter:image",
        content:
      ...
      {
        property: "og:url",
        content: "https://hoppscotch.com/changelog/23-04-2023",
      },
    ],
  })
