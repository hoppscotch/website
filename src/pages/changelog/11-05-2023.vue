<script setup lang="ts">
  useHead({
    title: "v2023.4.2 • Changelog • Hoppscotch",
    meta: [
      {
        property: "og:title",
        content: "v2023.4.2 • Changelog • Hoppscotch",
      },
      {
        name: "twitter:title",
        content: "v2023.4.2 • Changelog • Hoppscotch",
      ...
      },
      {
        property: "og:image",
        content:
          "https://next.hoppscotch.com/.netlify/functions/og-image?type=changelog&slug=11-05-2023",
      },
      {
        name: "twitter:image",
        content:
      ...
      {
        property: "og:url",
        content: "https://next.hoppscotch.com/changelog/11-05-2023",
      },
    ],
  })
