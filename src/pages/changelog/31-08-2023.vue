<script setup lang="ts">
  useHead({
    title: "v2023.8.0 • Changelog • Hoppscotch",
    meta: [
      {
        property: "og:title",
        content: "v2023.8.0 • Changelog • Hoppscotch",
      },
      {
        name: "twitter:title",
        content: "v2023.8.0 • Changelog • Hoppscotch",
      ...
      {
        name: "description",
        content: "Spotlight, environment quick peek and GraphQL improvements.",
      },
      {
      ...
      },
      {
        property: "og:image",
        content:
          "https://next.hoppscotch.com/.netlify/functions/og-image?type=changelog&slug=27-06-2023",
      },
      {
        name: "twitter:image",
        content:
      ...
      {
        property: "og:url",
        content: "https://next.hoppscotch.com/changelog/27-06-2023",
      },
    ],
  })
