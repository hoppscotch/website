<script setup lang="ts">
  useHead({
    title: "v2023.4.8 • Changelog • Hoppscotch",
    meta: [
      {
        property: "og:title",
        content: "v2023.4.8 • Changelog • Hoppscotch",
      },
      {
        name: "twitter:title",
        content: "v2023.4.8 • Changelog • Hoppscotch",
      ...
      },
      {
        property: "og:image",
        content:
          "https://next.hoppscotch.com/.netlify/functions/og-image?type=changelog&slug=18-07-2023",
      },
      {
        name: "twitter:image",
        content:
      ...
      {
        property: "og:url",
        content: "https://next.hoppscotch.com/changelog/18-07-2023",
      },
    ],
  })
