...
<template>
  <div class="flex flex-col px-8 py-16">
    ...
    <div class="flex flex-col items-center">
      <h1
        class="block w-full max-w-2xl mt-4 text-5xl leading-none tracking-tighter text-center transition text-secondaryDark interactive-font md:text-6xl lg:text-7xl"
      >
        {{ t("home.hero.heading") }}
      </h1>
      <h1
        class="block w-full max-w-2xl mb-4 text-5xl leading-none tracking-tighter text-center text-transparent transition bg-clip-text bg-gradient-to-r interactive-font md:text-6xl lg:text-7xl"
