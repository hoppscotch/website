...
<template>
  <router-link
    :to="to"
    class="bg-green-600 font-semibold text-white py-2 transition inline-flex items-center justify-center hover:bg-accentDark focus:outline-none focus-visible:bg-accentDark"
    :class="[
      label ? 'px-4' : 'px-2',
