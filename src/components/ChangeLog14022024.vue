<template>
  <article id="14-02-2024" class="md:flex">
    <p
    ...
    >
      <a href="#14-02-2024" class="rounded">February 14, 2024</a>
    </p>
    <div class="relative pb-16 pl-7 pt-2 md:w-4/5 md:pl-12 md:pt-0">
      ...
      <div>
        <h1 class="mb-8 text-2xl font-semibold text-zinc-200 sm:text-4xl">
          <RouterLink class="rounded" to="/changelog/14-02-2024">
            Bug fixes and performance improvements
          </RouterLink>
        </h1>
        <p class="mb-8 mt-4 text-zinc-400/80">
          This release introduces minor bug fixes, some minor UX improvements
          and introduces the Secret Environment Variables feature along with the
          ability to use atob and btoa functions in scripting.
        </p>
        ...
        >
          <li class="pl-4">Secret variables in environments.</li>
          <li class="pl-4">Secret environment variables in CLI.</li>
          <li class="pl-4">Persist line wrap setting.</li>
          <li class="pl-4">Expose atob & btoa functions for Node.js.</li>
        </ul>
        <h5 class="flex items-center">
        ...
        >
          <li class="pl-4">OAuth 2.0 ux improvements.</li>
        </ul>
      </div>
    </div>
  </article>
