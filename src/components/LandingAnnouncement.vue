  ...
  <div class="flex flex-col py-16">
    <div class="relative flex items-center justify-center flex-1">
      <SmartLink
        ...
        class="relative flex items-center justify-center py-2 border rounded-full bg-primary border-divider text-secondaryLight transition group hover:bg-primaryLight hover:border-dividerDark hover:text-secondaryDark"
      >
        ...
        <span class="px-4 py-1 border-r rounded-l-full border-divider">
          ...
          <span class="hidden md:inline">
            {{ t("home.announcement.long_description") }}
          </span>
        </span>
        <span
          class="flex items-center justify-center px-4 font-semibold rounded-r-full text-accentLight transition group-hover:text-accent"
        >
          <span class="md:hidden">
