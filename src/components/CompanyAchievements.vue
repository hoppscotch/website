      ...
      <div class="pt-6 pb-12 md:pt-8 md:pb-20">
        ...
        >
          ...
          <div class="relative flex flex-col items-center">
            <div
              aria-hidden="true"
              class="absolute h-0.5 bg-gradient-to-r from-gray-950 via-gray-800 to-gray-950 hidden md:block"
              style="
                width: calc(100% - 96px);
                left: calc(50% + 64px);
                top: 40px;
            ...
            <div class="text-sm text-gray-200">Founded in 2021</div>
          </div>
          <!-- Item -->
          <div class="relative flex flex-col items-center">
            <div
            ...
            <div class="relative w-20 h-20 mb-4">
              <div
                class="absolute inset-0 rounded-full opacity-30 bg-gradient-to-tr from-gray-500 -z-1"
                aria-hidden="true"
              ></div>
              <svg
            ...
            <div class="text-sm text-gray-200">Built-with Open Source</div>
          </div>
          <!-- Item -->
          <div class="relative flex flex-col items-center">
            <div
            ...
            <div class="text-sm text-gray-200">52,000+ GitHub Stars</div>
          </div>
          <!-- Item -->
          <div class="relative flex flex-col items-center">
            <div class="relative w-20 h-20 mb-4">
            ...
            <div class="text-sm text-gray-200">1.6M+ Users</div>
          </div>
        </div>
      </div>
    </div>
