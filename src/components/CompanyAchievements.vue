      ...
      <div class="pt-6 pb-12 md:pt-8 md:pb-20">
        ...
        >
          ...
          <div class="relative flex flex-col items-center">
            ...
            <div class="text-sm text-zinc-200">Founded in 2021</div>
          </div>
          <!-- Item -->
          <div class="relative flex flex-col items-center">
            <div
            ...
            <div class="text-sm text-zinc-200">Built-with Open Source</div>
          </div>
          <!-- Item -->
          <div class="relative flex flex-col items-center">
            <div
            ...
            <div class="text-sm text-zinc-200">52,000+ GitHub Stars</div>
          </div>
          <!-- Item -->
          <div class="relative flex flex-col items-center">
            <div class="relative w-20 h-20 mb-4">
            ...
            <div class="text-sm text-zinc-200">1.6M+ Users</div>
          </div>
        </div>
      </div>
    </div>
