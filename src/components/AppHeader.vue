...
<template>
  <header
    class="fixed top-0 z-30 w-full bg-neutral-950/5"
    :class="
      !isMobileMenuClosed
  ...
  >
    <div
      class="container px-4 py-4 transition sm:px-6 after:-z-10 after:absolute after:h-px after:inset-x-0 after:bottom-0 after:bg-gradient-to-r after:from-transparent after:via-neutral-500/20"
      :class="{
    ...
    >
      ...
      <div
        ...
        class="flex flex-col md:hidden rounded-xl"
      >
        <!-- Mobile CTA links -->
