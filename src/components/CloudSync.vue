  ...
  <div class="relative w-full p-2 overflow-hidden">
    ...
    >
      <div class="lines">
        <div class="line">
          <span
            class="relative z-10 inline-flex px-3 py-2 mt-4 text-xs border -translate-x-1/2 rounded-md border-gray-400/20 bg-gray-400/10 backdrop-blur-md"
          >
