    ...
    downloadLinks: [
      {
        ...
        url: "https://github.com/hoppscotch/releases/releases/download/v26.5.0-0/Hoppscotch_mac_aarch64.dmg",
      },
      {
        name: "Download for Mac &nbsp; ~ &nbsp; Intel",
        url: "https://github.com/hoppscotch/releases/releases/download/v26.5.0-0/Hoppscotch_mac_x64.dmg",
      },
    ],
  },
  {
    ...
    downloadLinks: [
      {
        ...
        url: "https://github.com/hoppscotch/releases/releases/download/v26.5.0-0/Hoppscotch_win_x64.msi",
      },
      {
        name: "Download for Windows &nbsp; ~ &nbsp; Portable",
        url: "https://github.com/hoppscotch/releases/releases/download/v26.5.0-0/Hoppscotch_Cloud_win_x64_portable.zip",
      },
    ],
  },
  {
    ...
    downloadLinks: [
      {
        ...
        url: "https://github.com/hoppscotch/releases/releases/download/v26.5.0-0/Hoppscotch_linux_x64.deb",
      },
      {
        name: "Download for Linux &nbsp; ~ &nbsp; .AppImage",
        url: "https://github.com/hoppscotch/releases/releases/download/v26.5.0-0/Hoppscotch_linux_x64.AppImage",
      },
    ],
  },
  {
