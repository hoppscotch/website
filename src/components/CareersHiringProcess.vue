  ...
  <div class="flex flex-col px-8 py-16">
    ...
    <div class="relative items-start justify-between py-5 grid grid-cols-1 md:grid-cols-2 gap-30">
      ...
      <div class="flex flex-col">
        <CareersProcessCard v-for="(processTips,processTipsIndex) in interviewProcess" :key="`interview-process-${processTipsIndex}`" :visible-tip="processTips" :tip-index="processTipsIndex" @set-active-tip="setActiveTip" />
      </div>
    </div>
  </div>
</template>
