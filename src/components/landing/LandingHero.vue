...
<template>
  <div class="flex flex-col px-8 py-16">
    <div class="grainy-gradient relative flex flex-col">
      <LandingAnnouncement />
      <div
        class="grainy-text w-full max-w-4xl mx-auto mt-4 mb-4 text-5xl tracking-tight text-center text-transparent transition bg-clip-text md:text-6xl lg:text-8xl"
      >
        {{ t("home.hero.heading") }}
      </div>
