  ...
  <div class="relative w-full p-2 overflow-hidden">
    ...
    >
      <img
        ...
        class="max-w-none border border-zinc-600/50 h-[560px] w-[560px] brightness-110 bg-gradient-to-tr from-zinc-400/5 via-transparent to-zinc-400/5 shadow-[0_0_64px_32px_theme(colors.zinc.900)_inset] mt-80 rounded-full animate-[spin_600s_linear_infinite]"
      />
    </div>
  </div>
</template>
