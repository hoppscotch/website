...
<template>
  <div class="relative w-full p-2 overflow-hidden">
    ...
    >
      ...
      >
        <div
          v-for="(tab, index) in tabOptions.tabs"
          :key="index"
          class="inline-flex flex-shrink-0 px-4 py-2"
          :class="
            tabOptions.activeTab === tab.name
              ? 'border-b border-neutral-800 text-neutral-600'
              : 'text-neutral-800'
          "
        >
          {{ tab.name }}
      ...
      <div
        class="flex items-center justify-center flex-1 w-full text-neutral-400/25"
      >
        <span
